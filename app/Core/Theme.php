...
class Theme
{
    ...
    {
        if (file_exists(public_path('storage/assets/media/icons/'.$path))) {
            return sprintf('<span class="%s">%s</span>', $classNames, file_get_contents(public_path('storage/assets/media/icons/'.$path)));
        }
