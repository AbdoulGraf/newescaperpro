...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="/" style="width: 100%; text-align: center; ">
		<img alt="Logo" src="{{ image('logos/logo_white.webp') }}" class="h-40px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/logo_white.webp') }}" class="h-10px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
