<footer class="main_footer">
    ...
    <div class="footer-top footer-bg s-footer-bg">
        ...
        <div class="footer-fire"><img src="{{ asset('assets/site/images/footer/left.webp') }}" alt></div>
        <div class="footer-fire footer-fire-right"><img src=" {{ asset('assets/site/images/footer/right.webp') }}" alt>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="payment-method-img text-right">
                            <img src="{{ asset('assets/site/images/footer/escape-footer-logo.webp') }}" alt="img">
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-none d-md-block">
                        <div class="payment-method-img text-right">
                            <img src="{{ asset('assets/site/images/footer/card_img.png') }} " alt="img">
                        </div>
                    </div>
                </div>
            </div>
