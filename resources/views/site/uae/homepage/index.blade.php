...
@section('content')
        ...
        <div class="banner-carousel owl-theme owl-carousel">
            ...
            <div class="slide-item">
                <div class="image-layer"
                    style="background-image:url('{{ asset('assets/site/images/uae/bannerBackground.png') }}');"></div>
                ...
                <div class="auto-container">
                    <div class="content-box">
                        <div class="content">
                            <h2>
                                U.A.E'S <span class="most_scary_word">MOST
                                    SCARY</span> <br>
                                ESCAPE ROOMS.
                            </h2>
                            ...
                            <h5 class="banner_h5_title"> <strong>Escape
                                    House</strong> is the
                                perfect place for a team work <br>
                                together
                                and achieve one goal: Success.</h5>
    ...
    <!-- top title section -->
    <section class="featured-game-area position-relative  pt-115 pb-90 bg-dark" style="margin-top: 90px;">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title title-style-three text-center mb-70">
                        <h2 class="mb-3"> <span>
                            ...
                            GAMES</h2>
                        <p style="color: #fff;"> THE MOST SCARY ROOMS
                            WITH LIVE ACTORS!</p>
                    </div>
                </div>
            </div>
    ...
    <section class="inner-about-area fix vr_game_home_banner_image">
        <div class="container">
            <div class="row align-items-center" style="position: relative; z-index: 1;">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="section-title title-style-three">
                        <!-- <h2> <span class="vr_write">VR</span> <br>
                                                <span> HOUSE</span></h2> -->
                        <img src="{{ asset('assets/site/images/rooms/uae/vr_game_home.webp') }} " alt>
                    </div>
                    <div class="inner-about-content">
                        <!-- <h5>Monica Global Publishing for Marketing</h5> -->
                        <p> <strong>VR House </strong> offers a unique
                            virtual reality
                            experience,
                            ...
                            <strong>VR House</strong>.

                        </p>

                        <a href="../vrgames/indexhome.html" class="btn btn-style-two"
                            style="background: url('{{ asset('assets/site/images/icons/vrgames.svg') }}'); background-size: cover; background-position: center; padding: 40px 60px;">
                            GET
                            STARTED </a>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                    ...
                    <div class="inner-box">
                        <figure class="image-box"><a href="./blog/index.html"><img
                        ...
                        <div class="over-box">
                            ...
                            <div class="content">
                                <h3><a href="./blog/index.html">Lorem
                                        ipsum</a></h3>
                                <p>
                ...
                <!--News Block-->
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><a href="./blog/blog_details.html"><img
                                    src="{{ asset('assets/site/images/blog/1.webp') }}" alt title></a></figure>
                        <div class="over-box">
                            ...
                            <div class="content">
                                <h3><a href="./blog/blog_details.html">Lorem
                                        ipsum</a></h3>
                                <p>
                                    VR House offers a unique virtual
                                    reality
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                    ...
                    <div class="inner-box">
                        <figure class="image-box"><a href="#"><img
                                    src="{{ asset('assets/site/images/blog/1.webp') }}" alt title></a>
                        </figure>
                        <div class="over-box">
