...
<head>
    ...
    @yield('meta_tags')
    @include('site.vrgames.layouts.css')
    @yield('styles')
    @livewireStyles


    @if (App::environment('APP_URL') != 'https://escapehouseuae.com/')
...
<body>
    ...
    <div class="page-wrapper">
        ...
        @include('site.vrgames.layouts.header')
 ...
 @include('site.dubai.layouts.header2') --}}
        ...
        <!-- main-area-end -->
        <!-- footer-area -->
        @include('site.vrgames.layouts.footer')
        <!-- footer-area-end -->
    ...
    <!-- JS here -->
    @include('site.vrgames.layouts.js')
    @yield('scripts')
    @livewireScripts
