<header class="main-header header-style-two mobile__main__header__back">
                        ...
                        <ul class="info clearfix">
                            <li>
                                <img
                                    ...
                                    alt="Black Out phone number" style="max-width: 29px;">
                                <a href="tel:+971586000041">+971 58 600 0041</a></li>
                            <li>
                                <img
                                    src="{{asset('assets/site/images/logoPart/mail_icon.webp')}}"
                                    alt="Black Out Email Address" style="max-width: 29px;">
                                &nbsp;
                                <a
            ...
            <div class="auto-container" style="max-width:1600px">
                <div class="inner-container clearfix">
                    ...
                    <div class="logo-box mobile__logo__move">
                        <div class="logo"><a href="{{route('homeabudhabi.index')}}"
                                title="Black-out Rooms in Abudhabi | Black-Out"><img
                                    src="{{asset('assets/site/images/newImages/newImage1.webp')}}"
                                    alt="Black-out Rooms in Abudhabi | Black-Out"
                                    title="Black-out Rooms in Abudhabi | Black-Out"
                        ...
                        <nav
                            ...
                            <div
                                ...
                                <ul class="navigation clearfix">
                                    <li class="current "><a
                                            href="{{route('homeabudhabi.index')}}">HOME</a>
                                    ...
                                    <li class="dropdown"><a
                                        ...
                                        <ul>
                                            <li><a
                                                    href="{{route('abudhabi.faq')}}">Faq</a></li>
                                            <li><a
                                                    href="{{route('abudhabi.terms')}}">Terms
                                                    &
                                                    Conditions</a></li>
                                            ...
                                            <li><a
                                                    href="{{route('abudhabi.teambuilding')}}">
                                                    Team
                                                    Building</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a
                                            href="{{route('abudhabi.franchise')}}">FRANCHISE</a></li>

                                    <li class><a
                                            href="{{route('abudhabi.blog')}}">BLOG</a>

                                    </li>
                                    <li><a
                                            href="{{route('abudhabi.contact')}}">CONTACT</a></li>
        ...
        <div class="auto-container clearfix">
            ...
            <div
                ...
                <div class="logo pull-left">
                    <a href="{{route('homeabudhabi.index')}}" title><img
                        src="{{asset('assets/site/images/newImages/newImage1.webp')}}"
                        alt="Black-out Rooms in Abudhabi | Black-Out"
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="{{route('homeabudhabi.index')}}"><img
                src="{{asset('assets/site/images/newImages/newImage1.webp')}}" alt="Black-out Rooms in Abudhabi | Black-Out"
                        title></a></div>
            <div
