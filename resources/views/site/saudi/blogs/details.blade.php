                    ...
                    <div class="sidebar-page-container">
                        <div class="auto-container">
                            <div class="row clearfix">
                                ...
                                <div
                                    class="content-side col-lg-8 col-md-12 col-sm-12">
                                    ...
                                    <div class="blog-detail">
                                        ...
                                        <div class="lower-content">
                                            <div class="date"><span class="date-title">{{ $blog->created_at->format('d M, Y') }}</span></div>
                                            <h3>{{ $blog->title }}</h3>
                                            <p>{!! $blog->content !!}</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="social-links">
                                            <ul class="default-social-links clearfix">
                                                ...
                                                @foreach($socialMedia as $media)
                                                    <li>
                                                        <a href="{{ 'https://www.'.$media->platform.'.com/'.$media->username }}" target="_blank">
                                        ...
                                        <div class="sidebar-widget categories">
                                            <div class="widget-content">
                                                ...
                                                <ul class="blog-categories">
                                                    <li><a
                                                            href="{{ route('rooms.detail', ['slug' => 'psychiatric']) }}">Psychiatric</a></li>
                                                    <li><a
                                                            href="{{ route('rooms.detail', ['slug' => 'exorcism']) }}">Exorcism</a></li>
                                                    <li><a
